-- Script para popular eventos demo no banco de dados
-- Execute este script no seu banco de dados para criar os eventos demo completos

-- 1. Inserir Eventos Demo
...
-- 2. Inserir Categorias para cada evento
...
-- 3. Inserir Produtos para cada evento
...
-- 4. Inserir Usuário Demo (opcional)
...
VALUES ('demo-user-123', 'Usuário Demo', 'demo@filazero.com', '(11) 99999-9999', '12345678900', 3, 'demo_hash', 'demo_salt', 1, GETDATE(), GETDATE(), GETDATE(), 1);

PRINT 'Eventos demo populados com sucesso!';
PRINT 'Total de eventos: 4';
PRINT 'Total de categorias: 13';
PRINT 'Total de produtos: 26';
