        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorPrimaria = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false, defaultValue: "#007bff"),
                    CorSecundaria = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false, defaultValue: "#6c757d"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nome = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Descricao = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Cor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false, defaultValue: "#007bff"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxaServico = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m),
                    ...
                    DataPreparo = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DataPronto = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DataEntregue = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pedidos_Usuarios_ConsumidorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TempoPreparoMinutos = table.Column<int>(type: "int", nullable: false, defaultValue: 15),
                    Ordem = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TransacaoId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Valor = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Metodo = table.Column<int>(type: "int", nullable: false),
                    GatewayPagamento = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    RespostaGateway = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
