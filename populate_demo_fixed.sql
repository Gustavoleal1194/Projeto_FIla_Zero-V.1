-- Script corrigido para popular eventos demo

-- 1. Inserir Categorias Rock
INSERT INTO Categorias (Id, Nome, Descricao, Cor, Ativo, EventoId, Ordem, CreatedAt, UpdatedAt, IsActive)
VALUES 
(NEWID(), '🍔 Lanches', 'Hambúrgueres e lanches', '#FF6B35', 1, '11111111-1111-1111-1111-111111111111', 1, GETDATE(), GETDATE(), 1),
(NEWID(), '🍟 Acompanhamentos', 'Batatas e petiscos', '#E55A2B', 1, '11111111-1111-1111-1111-111111111111', 2, GETDATE(), GETDATE(), 1),
(NEWID(), '🍺 Bebidas', 'Cervejas e refrigerantes', '#D44A1F', 1, '11111111-1111-1111-1111-111111111111', 3, GETDATE(), GETDATE(), 1);

-- 2. Inserir Produtos Rock
INSERT INTO Produtos (Id, Nome, Descricao, Preco, ImagemUrl, Disponivel, CategoriaId, EventoId, TempoPreparoMinutos, Ordem, CreatedAt, UpdatedAt, IsActive)
SELECT 
    NEWID(),
    'Hambúrguer Rock',
